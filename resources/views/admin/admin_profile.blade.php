    ...
    <div class="card-body">
        ...
        <div class="align-items-center">
            <div class="d-flex align-items-center">
                <img src="{{ (!empty($profileData->photo)) ? url('upload/user_images'.$profileData->photo) : url('upload/profile.webp')}} " class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
                                ...
                                <form action="">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-lg-12 col-xl-12">
                                                <textarea class="form-control" type="text" name="address" required="">{{ $profileData->address }}</textarea>
                                            </div>
                                        </div>
