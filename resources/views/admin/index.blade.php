                                        ...
                                        <ul class="list-group custom-group">
                                            <li class="list-group-item align-items-center d-flex justify-content-between">
                                                <div class="product-list">
                                                    <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3" src="{{ asset('backend/assets/images/products/shoes.jpg') }}" alt="product-image">
                                            ...
                                            <li class="list-group-item align-items-center d-flex justify-content-between border-bottom">
                                                <div class="product-list">
                                                    <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3" src="{{ asset('backend/assets/images/products/bags.jpg') }}" alt="product-image">
                                            ...
                                            <li class="list-group-item align-items-center d-flex justify-content-between border-bottom">
                                                <div class="product-list">
                                                    <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3" src="{{ asset('backend/assets/images/products/dresses.jpg') }}" alt="product-image">
                                            ...
                                            <li class="list-group-item align-items-center d-flex justify-content-between border-bottom">
                                                <div class="product-list">
                                                    <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3" src="{{ asset('backend/assets/images/products/headphone.jpg') }}" alt="product-image">
                                            ...
                                            <table class="table table-traffic mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('backend/assets/images/users/user-12.jpg') }}" class="avatar avatar-sm rounded-2 me-3" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('backend/assets/images/users/user-11.jpg') }}" class="avatar avatar-sm rounded-2 me-3" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('backend/assets/images/users/user-13.jpg') }}" class="avatar avatar-sm rounded-2 me-3" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('backend/assets/images/users/user-14.jpg') }}" class="avatar avatar-sm rounded-2 me-3" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('backend/assets/images/users/user-15.jpg') }}" class="avatar avatar-sm rounded-2 me-3" />
