                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('custom.verification.verify') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="emailaddress" class="form-label">Verify Code</label>
                                                <input class="form-control" type="text" id="mailCode" name="mailCode" required="" placeholder="Enter your code">
                                                @error('code') 
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center mb-3"> 
                                                    <svg xmlns="{{asset('backend/http://www.w3.org/2000/svg')}}" width="24" height="24" viewBox="0 0 48 48" class="me-2">
                                            ...
                                            <div class="col-12">
                                                <a class="btn btn-primary fw-normal d-flex align-items-center justify-content-center mb-3">
                                                    <svg xmlns="{{asset('backend/http://www.w3.org/2000/svg')}}" width="24" height="24" viewBox="0 0 24 24" class="me-2">
