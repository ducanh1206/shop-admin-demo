        ...
        <div class="row">
          <div class="col-xxl-4 col-xl-12 col-md-6">
            <div class="lonyo-footer-textarea">
              ...
              <p>Your go-to destination for quality products, fast delivery, and unbeatable prices. Shop smarter, live better.</p>
        ...
        <div class="col-xxl-3 col-xl-4 col-md-6">
          <div class="lonyo-footer-menu pl-31 mb-0">
            ...
            <div class="lonyo-subscription-field2">
              ...
              <p class="mt-2 text-muted">Get the latest deals, news & promotions.</p>
            </div>
          </div>
        </div>
      </div>
